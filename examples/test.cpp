...
static_assert(variant_element_index<int,    qp::variant<int,char,float>>::value ==  0, "");
static_assert(variant_element_index<char,   qp::variant<int,char,float>>::value ==  1, "");
static_assert(variant_element_index<float,  qp::variant<int,char,float>>::value ==  2, "");
static_assert(variant_element_index<double, qp::variant<int,char,float>>::value == -1, "");
...
template <> struct has_styles<int> { using type = variant<Snippet>; };
using RequirementsTestTypes = std::tuple<int>;

void testing()
{
	Qplot<Python,RequirementsTestTypes> qp;
